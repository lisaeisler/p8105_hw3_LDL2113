...
The data set contains `r nrow(accel_data_tidy)'. This is the expected number of minutes in a 5 week period of time.  
...
Activity falls after hour 20 (8pm) and is almost zero until hour 5 (5am), reflecting a period of overnight sleep. Activity levels are fairly consistent from one day to the next during the afternoon hours. A variable spike in activity level is observed at roughly hours 8-9 (8-9am) and hours 19 (7pm) perhaps reflecting morning and evening activity such as working with therapy personnel (likely am) and perhaps hygiene or other activities (pm).